...
def default_prepare_state() -> Dict[str, Any]:
    return {
        ...
        "capabilities": {
            "hot": {"ready": False, "message": "Not prepared yet."},
            "download": {"ready": False, "message": "Not prepared yet."},
            "search": {"ready": False, "message": "Not prepared yet."},
            "comments": {"ready": False, "message": "Not prepared yet."},
            "watch": {"ready": False, "message": "Not prepared yet."},
            "subtitles": {"ready": False, "message": "Not prepared yet."},
            "player": {"ready": False, "message": "Not prepared yet."},
